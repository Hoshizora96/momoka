...
public:
	...
	int storage[maxGenreNum] = { 100, 20, 10, 10, 10, 10, 10, 10 ,10 ,10 };
	int maxStorage[maxGenreNum] = { 100, 20, 10, 10, 10, 10, 10, 10 ,10 ,10 };
	int bulletCD[maxGenreNum] = { 0, 1, 3, 1, 1, 1, 1, 1, 1, 1 };
